...
use crate::async_zip::error::Result;
pub use crate::async_zip::zip::calc_size;
use crate::async_zip::zip::{Descriptor, Directory, FileHeader, ToBytes};
use futures::{
...
mod tests {
    ...
    async fn test_zip_stream() -> Result<()> {
        let dir = PathBuf::from("src/async_zip");
